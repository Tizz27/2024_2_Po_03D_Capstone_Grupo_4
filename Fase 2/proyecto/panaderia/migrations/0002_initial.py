    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_adicional', models.DecimalField(decimal_places=0, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='Sucursal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sucursal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pedidos', to='panaderia.sucursal')),
            ],
            options={
                'db_table': 'Pedido',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredientes', models.ManyToManyField(blank=True, related_name='productos', to='panaderia.ingrediente')),
            ],
            options={
                'db_table': 'Producto',
            },
