...
from .views import base,gestion, modificar,eliminar,registrar_producto,base, mostrar_productos,registrar_cliente, salir, login_view,home,cerrar,agregar_al_carrito,ver_carrito,eliminar_del_carrito,contacto
